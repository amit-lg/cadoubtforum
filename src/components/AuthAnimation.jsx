        ...
        <div className="flex flex-col w-full">
          ...
          {loginView ? (
            <h3 className="text-white 2xl:text-lg text-base text-center w-[300px] mx-auto">
              Access your account to participate in discussions, share insights,
              and find solutions
            </h3>
          ) : (
            <h3 className="text-white 2xl:text-lg text-base text-center w-[300px] xl:w-[420px] mx-auto">
              Your journey to becoming a Chartered Accountant is easier with the
              right peers. Join our community to seek advice, share experiences,
              and grow together.
            </h3>
          )}
        </div>
