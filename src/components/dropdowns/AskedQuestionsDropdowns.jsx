...
import { setSubjects, setTopics, setPoints, setTopicValue, setTopicName, setPointsValue, setPointName, setSubjectName, setSubjectVlue } from "../../redux/reducers/askedQuestionsReducer";
import useDidMountEffect from "../../hooks/useUpdateEffect";
// import { dropdownData } from "../mocks/dummy";

const AskedQuestionDropdowns = ({
    pointError,
    type,
}) => {
    const { subjects, topics, points, subjectName, topicName, pointsName, subjectValue, topicValue, pointsValue } = useSelector((state) => state.asked);
...
export default AskedQuestionDropdowns;

AskedQuestionDropdowns.propTypes = {
