...
import { setSubjects, setTopics, setPoints, setTopicValue, setTopicName, setPointsValue, setPointName, setSubjectName, setSubjectVlue } from "../../redux/reducers/unansweredQuestionsReducer";
import useDidMountEffect from "../../hooks/useUpdateEffect";
// import { dropdownData } from "../mocks/dummy";

const UnansweredQuestionDropdowns = ({
    pointError,
    type,
}) => {
    const { subjects, topics, points, subjectName, topicName, pointsName, subjectValue, topicValue, pointsValue } = useSelector((state) => state.unanswered);
...
export default UnansweredQuestionDropdowns;

UnansweredQuestionDropdowns.propTypes = {
