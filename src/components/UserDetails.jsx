...
const UserDetails = () => {
  ...
  return (
    <Link onClick={closeSidebar} to="/profile" className={`${collapsedSidebar ? "flex-col gap-2 p-1" : "flex-row p-3"} rounded-md flex items-center relative ${collapsedSidebar ? "bg-transparent" : "bg-blue-700"}`}>
      <Avatar user={user} />
