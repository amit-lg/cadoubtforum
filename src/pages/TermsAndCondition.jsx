...
const TermsAndCondition = ({ onAccept, onDecline }) => {
  return (
    <div className="fade-enter flex flex-col gap-2 h-full">
      {/* Header */}
      <div className="h-[20%] w-full flex items-center  border-b px-8 gap-5">
        ...
        <div className=" flex flex-col">
          ...
          <p className="text-base text-gray-400">Last Updated Feb 2024</p>
        </div>
      </div>
      ...
      <div className="px-6 flex items-center gap-3 justify-end mt-3">
        <Button
          onClick={onDecline}
          className="px-3 py-3 border-blue-500 border-2 font-semibold text-black"
        >
          Decline
        </Button>
        <Button
