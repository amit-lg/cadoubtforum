...
const EmailVerification = () => {
  ...
  const { chooseCoursePopupState } = useSelector((state) => state.app);
  ...
  return (
    <div className="relative">
      <div className="z-0 flex items-center justify-center h-screen w-full">
        <div className="xl:w-[30%] lg:w-[40%] md:w-[50%] w-[70%] flex items-center justify-center">
          {loading ? (
            ...
            <div className="flex flex-col gap-3">
              ...
              />
              <Button onClick={goToDashboard} className="py-4 text-lg">
                Login
              </Button>
            </div>
          ) : (
            <div className="flex flex-col gap-3 items-center justify-center">
              ...
              <img
                ...
                alt="Email verification"
              />
              <Button onClick={goToLogin} className="w-full py-4 text-lg">
                Login
              </Button>
            </div>
          )}
